...
/**
 * Criteria class for the {@link com.lnduy.agriculture.domain.Fertilizers} entity. This class is used
 * in {@link com.lnduy.agriculture.web.rest.FertilizersResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /fertilizers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FertilizersCriteria implements Serializable, Criteria {
    ...
    public FertilizersCriteria() {}

    public FertilizersCriteria(FertilizersCriteria other) {
    ...
    @Override
    public FertilizersCriteria copy() {
        return new FertilizersCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FertilizersCriteria that = (FertilizersCriteria) o;
        return (
